...
namespace Kelsey.UGUI
{
    ...
    public class SafeArea : UpdateOptimizeMonoBehaviour
    {
        ...
        void Refresh()
        {
            ...
            var bannerHeight = 0f;
            if (Service.TryGet<IAdsService>(out var adsService))
            {
                bannerHeight = adsService.GetBannerHeight();
            }
            ...
            if (safeArea != LastSafeArea
                ...
                || !Mathf.Approximately(bannerHeight, lastBannerHeight))
            {
                ...
                ApplySafeArea(safeArea, bannerHeight);
            }
        }
        ...
        void ApplySafeArea(Rect safeArea, float bannerHeight)
        {
            ...
            Panel.sizeDelta = Panel.anchoredPosition = Vector3.zero;
            Panel.anchorMin = new Vector2(paddingLeft / width, paddingBottom / height);
            Panel.anchorMax = new Vector2((width - paddingRight) / width, (height - paddingTop) / height);
        }
